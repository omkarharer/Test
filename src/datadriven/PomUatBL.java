...
public class PomUatBL extends CloneUatBL implements IAuto {
    ...
    public PomUatBL(WebDriver driver)
    {
...
String bi = buisness_loan.getText();
	...
	public void loginNEO() throws InterruptedException
	{
		...
		public void loop() throws EncryptedDocumentException, IOException
		{
			Flib f = new Flib();
