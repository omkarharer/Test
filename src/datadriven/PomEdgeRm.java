...
import test.Check2;
import test.Cibilkarza;
import test.CloneBL;
import test.CloneUatBL;
import test.Document;

public class PomEdgeRm extends CloneBL implements IAuto {
    ...
    public PomEdgeRm(WebDriver driver)
    {
...
String bi = buisness_loan.getText();
	...
	public void loginNEO() throws InterruptedException
	{
		Thread.sleep(2000);
		...
		public void newCase() throws InterruptedException, EncryptedDocumentException, IOException, AWTException
		{
			...
			String pan = f.readDataW(excel_pathbl, "entity", 1, 0);
		...
		public void checkEntity() throws InterruptedException, EncryptedDocumentException, IOException 
		{
			Flib f = new Flib();
			 ...
			 double cin = f.readDataN(excel_pathbl, "entity", 1, 4 );
			// double phone = f.readDataN(excel_pathbl, "entity", 1, 7);
			 String phone1 = f.readDataNString(excel_pathbl, "entity", 1, 7);
			 String company = f.readDataW(excel_pathbl, "entity", 1, 8);
			// double mobile = f.readDataN(excel_pathbl, "entity", 1, 9);
			 String mobile1 = f.readDataNString(excel_pathbl, "entity", 1, 9);
			 double loan = f.readDataN(excel_pathbl, "entity", 1, 10);
			 String email2 = f.readDataW(excel_pathbl, "entity", 1, 11);
			 Date date = f.date(excel_pathbl,"entity", 1, 12);
			 String l3 = f.readDataLONGString(excel_pathsl, "entity", 1, 10);
			 long loan2 = (long) f.readDataN(excel_pathbl, "entity", 1, 10);
		...
		{
			Flib f = new Flib();
			String bn = f.readDataW(excel_pathbl, "entity", 1, 1);
			 double pin = f.readDataN(excel_pathbl, "entity", 1, 2 );
			 String ba = f.readDataW(excel_pathbl, "entity", 1, 3);
			 double cin = f.readDataN(excel_pathbl, "entity", 1, 4 );
			 String email = f.readDataW(excel_pathbl, "entity", 1, 5);	
			 double hsn = f.readDataN(excel_pathbl, "entity", 1, 6);
			// double phone = f.readDataN(excel_pathbl, "entity", 1, 7);
			 String phone1 = f.readDataNString(excel_pathbl, "entity", 1, 7);
			 String company = f.readDataW(excel_pathbl, "entity", 1, 8);
			// double mobile = f.readDataN(excel_pathbl, "entity", 1, 9);
		...
		{
			Flib f = new Flib();
			String p = f.readDataW(excel_pathbl, "entity", 1, 0);
			String fn = f.readDataW(excel_pathbl, "entity", 1, 13);
			//Date date = f.date(excel_pathbl, "entity", 1, 14);
		...
		public void checkAddCoApp() throws InterruptedException, EncryptedDocumentException, IOException
		{
			...
			String mobile1 = f.readDataNString(excel_pathbl, "co-applicant", 1, 6);
			...
			Thread.sleep(2000);
			co_applicant_mobile_no.sendKeys(mobile1);
			Thread.sleep(2000);
		...
		public void cibilUpload() throws InterruptedException, EncryptedDocumentException, IOException
		{
			karza_utility.click();
			Thread.sleep(2000);
			karza_mockdataupload.click();
			...
			karza_cibilpan.sendKeys(pan);
			
			  //  karza_cibildata.sendKeys();
			
			//    karza_cibilhtml.sendKeys();
			
			//    karza_cibilxml.sendKeys();
		...
		public void poi() throws AWTException, InterruptedException
		{
			...
			wait.until(ExpectedConditions.elementToBeClickable(document_poi));
		...
		public void poa() throws InterruptedException
		{
			...
			// Create a new WebDriverWait object that will wait for up to 30 seconds
						...
						wait.until(ExpectedConditions.elementToBeClickable(document_poa));
						  JavascriptExecutor js=(JavascriptExecutor) driver;
						  js.executeScript("arguments[0].click()", document_poa);
		...
		public void applicationForm() throws InterruptedException
		{
			...
			// JavascriptExecutor js=(JavascriptExecutor) driver;
			 //Thread.sleep(2000);
			  //js.executeScript("arguments[0].click()", document_Appform);
		...
		public void partnership() throws InterruptedException
		{
			...
			// JavascriptExecutor js=(JavascriptExecutor) driver;
			 // js.executeScript("arguments[0].click()", document_partership);
		...
		public void pan() throws InterruptedException
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			Thread.sleep(3000);
			  js.executeScript("arguments[0].click()", document_pan);
			//document_pan.click();
			Thread.sleep(3000);
		...
		public void coAppPoi() throws InterruptedException
		{
			...
			//JavascriptExecutor js=(JavascriptExecutor) driver;
			 // js.executeScript("arguments[0].click()",document_coappdroppoi);
		...
		public void coAppPoa()
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			  js.executeScript("arguments[0].click()",document_coapp_poa);
		...
		public void coAppPhoto() throws InterruptedException
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			  js.executeScript("arguments[0].click()",document_coapp_photo);
		...
		public void signature() throws InterruptedException
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			  js.executeScript("arguments[0].click()",document_coapp_sign);
		...
		public void coAppPan() throws InterruptedException
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			  js.executeScript("arguments[0].click()",document_coapp_pan);
		...
		public void banking()
		{
			...
			JavascriptExecutor js=(JavascriptExecutor) driver;
			  js.executeScript("arguments[0].click()",document_banking_bankstate);
		...
		public void bankingCoAppSelectfile() throws InterruptedException
		{
			...
			document_banking_save.click();
			Thread.sleep(3000);
			document_banking_AssigntoCO.click();
			
		}
		
		public void loop() throws EncryptedDocumentException, IOException, InterruptedException
		{
			
			Flib f = new Flib();
			JavascriptExecutor js=(JavascriptExecutor) driver;
			int rc = f.rowcount(excel_path, "entity");
			for(int i=1;i<rc;i++)
			{
			...
			if(check.isEnabled())
			{
				...
				String industrytype = f.readDataW(excel_pathbl, "entity", i, 15);
				String product = f.readDataW(excel_pathbl, "entity", i, 16);
				String scheme = f.readDataW(excel_pathbl, "entity", i, 17);
				String branch = f.readDataW(excel_pathbl, "entity", i, 18);
				String segment = f.readDataW(excel_pathbl, "entity", i, 20);
				String buisnesst = f.readDataW(excel_pathbl, "entity", i, 21);
				...
				Thread.sleep(3000);
				System.out.println("entity loop start");
				
				String bn = f.readDataW(excel_pathbl, "entity", i, 1);
				 double pin = f.readDataN(excel_pathbl, "entity", i, 2 );
				 String ba = f.readDataW(excel_pathbl, "entity", i, 3);
				 double cin = f.readDataN(excel_pathbl, "entity", i, 4 );
				 String email = f.readDataW(excel_pathbl, "entity", i, 5);	
				 double hsn = f.readDataN(excel_pathbl, "entity", i, 6);
				// double phone = f.readDataN(excel_pathbl, "entity", i, 7);
				 String phone1 = f.readDataNString(excel_pathbl, "entity", i, 7);
				 String company = f.readDataW(excel_pathbl, "entity", i, 8);
				// double mobile = f.readDataN(excel_pathbl, "entity", i, 9);
				 String mobile1 = f.readDataNString(excel_pathbl, "entity", i, 9);
				 double loan = f.readDataN(excel_pathbl, "entity", i, 10);
				 String email2 = f.readDataW(excel_pathbl, "entity", i, 11);
				 Date date = f.date(excel_pathbl,"entity", i, 12);
				 long loan2 = (long) f.readDataN(excel_pathbl, "entity", i, 10);
				 String l3 = f.readDataLONGString(excel_pathsl, "entity", i, 10);
				// owned_button.click();
			//	GSTN.sendKeys("GST EXEMPT");
				Thread.sleep(2000);
				date_of_pan.sendKeys("01011990");
				...
				//add_coapplicant.click();	
				//this.entity();
				System.out.println("Entity Loop end");
			...
			else
			{
	           ...
	           // Flib f = new Flib();
				...
				System.out.println("Check entity start");
				 double cin = f.readDataN(excel_pathbl, "entity", i, 4 );
					// double phone = f.readDataN(excel_pathbl, "entity", i, 7);
					 String phone1 = f.readDataNString(excel_pathbl, "entity", i, 7);
					 String company = f.readDataW(excel_pathbl, "entity", i, 8);
					...
					System.out.println("check entity end");
			...
			if (cop1.size() > 0) {
			    ...
			    System.out.println("Coapp if block ");
			    WebElement cop2 = driver.findElement(By.xpath("//label[.='PAN']"));
				js.executeScript("arguments[0].click()", cop2);
			   
				Thread.sleep(3000);

				this.addCoApplicant();
				
				System.out.println("addCoApplicant() start");
				
				String pan = f.readDataW(excel_pathbl, "co-applicant", i, 0);
				String fn = f.readDataW(excel_pathbl, "co-applicant", i, 1);
				String mn = f.readDataW(excel_pathbl, "co-applicant", i, 2);
				String ln = f.readDataW(excel_pathbl, "co-applicant", i, 3);
				int sh = f.readDataIN(excel_pathbl, "co-applicant", i, 4);
				String email = f.readDataW(excel_pathbl, "co-applicant", i, 5);
				//double mobile = f.readDataN(excel_pathbl, "co-applicant", i, 6);
				String mobile1 = f.readDataNString(excel_pathbl, "co-applicant", i, 6);
				double pin = f.readDataN(excel_pathbl, "co-applicant", i, 7);
				String a1 = f.readDataW(excel_pathbl, "co-applicant", i, 8);
				String a2 = f.readDataW(excel_pathbl, "co-applicant", i, 9);
				String a3 = f.readDataW(excel_pathbl, "co-applicant", i, 10);
				...
				System.out.println("addCoApplicant() end");
				//Flib f = new Flib();
				String relationship = f.readDataW(excel_pathbl, "co-applicant", i, 12);
				...
				Thread.sleep(2000);
				//this.addCoApplicantElse();
				System.out.println("addCoApplicantElse start");
				String pan = f.readDataW(excel_pathbl, "co-applicant", i, 0);
				String fn = f.readDataW(excel_pathbl, "co-applicant", i, 1);
				String mn = f.readDataW(excel_pathbl, "co-applicant", i, 2);
				String ln = f.readDataW(excel_pathbl, "co-applicant", i, 3);
