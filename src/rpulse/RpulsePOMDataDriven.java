...
public class RpulsePOMDataDriven extends RpulseD implements Iauto {
	...
	@FindBy(xpath ="//*[@id='MainContent_dvResponseGrid']/table/tbody/tr[1]/td[2]") private WebElement App_id;
	 ...
	 public RpulsePOMDataDriven(WebDriver driver)
	    {
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 2, 1);
		log = Logger.getLogger(RpulsePOMDataDriven.class);
	...
	public void provisionalItCertificate() throws InterruptedException, EncryptedDocumentException, IOException
	{
		  ...
		  Flib f = new Flib(); 
		  int a = f.readDataIN(rpulse, "EHFL", 1, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 3, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 4, 1);
		log = Logger.getLogger(RpulsePOMDataDriven.class);
		PropertyConfigurator.configure("log4j.properties");
		//Letters.click();
		Thread.sleep(2000);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 5, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 6, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 7, 1);
		log = Logger.getLogger(RpulsePOMDataDriven.class);
		PropertyConfigurator.configure("log4j.properties");
		//Letters.click();
		Thread.sleep(2000);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 8, 1);
		log = Logger.getLogger(RpulsePOMDataDriven.class);
		PropertyConfigurator.configure("log4j.properties");
		Letters.click();
		Thread.sleep(2000);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 9, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 10, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 11, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 12, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 13, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 14, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 15, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 16, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 17, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 18, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 19, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 20, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 21, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 22, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 23, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 24, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 25, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 26, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 27, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 28, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 29, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 30, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 31, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 32, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 33, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 34, 1);
	...
	{
		Flib f = new Flib();
		int a = f.readDataIN(rpulse, "EHFL", 35, 1);
