...
public class CloneBL implements IAuto {
...
System.setProperty("webdriver.msedge.driver", "./drivers/msedgedriver.exe");
	   ...
	   driver=new EdgeDriver(options);	
		...
		if(check.isEnabled())
		{
			...
			String industrytype = f.readDataW(excel_pathbl, "entity", 1, 15);
			String product = f.readDataW(excel_pathbl, "entity", 1, 16);
			String scheme = f.readDataW(excel_pathbl, "entity", 1, 17);
			String branch = f.readDataW(excel_pathbl, "entity", 1, 18);
			String segment = f.readDataW(excel_pathbl, "entity", 1, 20);
			String buisnesst = f.readDataW(excel_pathbl, "entity", 1, 21);
